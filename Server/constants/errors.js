exports.UNAUTHORIZED = {
  NOT_LOGGED_IN: "You are not logged in. Please login to continue.",
  INVALID_JWT: `Invalid token! Please Login Again`,
  EXPIRED_JWT: `Your token has expired! please login again`,
  NOT_VERIFIED: "Your Account is not verified, Please Verify Your Account.",
  INVALID_EXPIRED: `Token is invalid or Has been Expired`,
  PASSWORD_CHANGED: "You have recently changed your Password! Please login again.",
...
exports.INVALID = {
  ...
  PASSWORD_MISMATCH: "Password and ConfirmPassword did not match",
  ...
  INVALID_CODE: "Code is Requried OR Invalid",
